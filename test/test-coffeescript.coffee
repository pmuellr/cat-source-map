...
describe "CoffeeScript support", ->
    ...
    it "should handle one CoffeeScript file", (done) ->
        utils.coffeec "--map sample_01.coffee"
    ...
    it "should handle two CoffeeScript files", (done) ->
        utils.coffeec "--map sample_01.coffee"
        utils.coffeec "--map sample_02.coffee"
